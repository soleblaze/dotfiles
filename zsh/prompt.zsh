# Generated by Powerlevel10k configuration wizard on 2019-10-20 at 15:40 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_{LEFT,RIGHT}_SUBSEGMENT_SEPARATOR='%04F)%04F┄%04F('
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%04F('
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%014F)12F─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX=''
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%04F)'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%04F─%014F('
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%04F)'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%04F)─'
    # Add a space between the filler and the start of right prompt.
    typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%014F─%04F─('
    ...
    typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%04F)'
    typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%04F('
  fi
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='%04F❯'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='%002F❯'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='%003F❯'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%9F'  # orange foreground
      local   modified='%9F'  # orange foreground
      local  untracked='%9F'  # orange foreground
      local conflicted='%9F'  # orange foreground
    fi
...
# Set PS2
PS2='%014F─%04F─(%003F%_%04F)─%014F─ '
PS3='%014F─%04F─(%003F?#%04F)─%014F─ '
PS4='%014F─%04F─(%003F+%N:%i%04F)─%014F─ '
